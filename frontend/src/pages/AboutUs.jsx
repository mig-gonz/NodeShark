      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="font-normal text-base leading-6 text-gray-900 mb-2">
            We decided to create this website so we could present it to our
            class as our final project. The hope is to one day become web
            developers and continue to grow our knowledge in the field we all
            love.
          </p>
          <p className="font-normal text-base leading-6 text-gray-900 mb-2">
            The difficulties of the project were not too big to handle; we
            continuously chatted about how to get past any humps we faced, and
            in the end, we created NodeShark. We hope you have enjoyed the
            preview of our futures.
          </p>
          <p className="font-normal text-base leading-6 text-gray-900 mb-2">
