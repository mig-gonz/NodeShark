import sitUp from "../assets/hayley-kim-design-eot-ka5dM7Q-unsplash.jpg";
import curl from "../assets/anastase-maragos-7kEpUPB8vNk-unsplash.jpg";

const Banner = () => {
  return (
    <div
      className="flex flex-col w-full lg:flex-row mt-6"
      style={{ height: "35em" }}
    >
